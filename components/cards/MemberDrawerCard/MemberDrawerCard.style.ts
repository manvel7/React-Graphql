...
import { memberDrawerCardProps } from './MemberDrawerCard';

interface MemberDrawerCardProps {
	height: memberDrawerCardProps;
}

export const MemberDrawerCardContainer = styled.div<MemberDrawerCardProps>`
	display: flex;
	flex-direction: column;
	${props =>
		props.height === memberDrawerCardProps.Craditionals &&
		css`
			height: 105rem;
		`}
`;
