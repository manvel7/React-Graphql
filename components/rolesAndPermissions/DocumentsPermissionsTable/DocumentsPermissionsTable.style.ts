...
export const DocumentPermissionsTableContainer = styled.div`
	width: 95rem;
	margin-top: 8rem;
`;

export const DocumentPermissionsHeader = styled.div`
	display: flex;
	align-items: center;
	flex: 1;
`;

export const DocumentPermissionsTitle = styled.p`
	font-size: 1.6rem;
	font-weight: 700;
...
export const TableContainer = styled.div<ShowAllProps>`
	...
	max-width: 100%;
	margin-top: 2rem;
	height: ${props => (props.showAll ? 'auto' : '23rem')};
