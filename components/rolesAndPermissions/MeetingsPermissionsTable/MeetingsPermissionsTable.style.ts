...
export const MeetingsPermissionsTableContainer = styled.div`
	width: 95rem;
	margin-top: 8rem;
`;

export const MeetingsPermissionsHeader = styled.div`
	display: flex;
	align-items: center;
	flex: 1;
`;

export const MeetingsPermissionsTitle = styled.p`
	font-size: 1.6rem;
	font-weight: 700;
