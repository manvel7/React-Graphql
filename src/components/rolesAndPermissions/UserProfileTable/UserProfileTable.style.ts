...
export const UserPermissionsTableContainer = styled.div`
	width: 95rem;
	margin: 8rem 0 3rem 0;
`;

export const UserPermissionsHeader = styled.div`
	display: flex;
	align-items: center;
	flex: 1;
`;

export const UserPermissionsTitle = styled.p`
	font-size: 1.6rem;
	font-weight: 700;
...
export const TableContainer = styled.div<ShowAllProps>`
	...
	max-width: 100%;
	margin-top: 2rem;
	height: ${props => (props.showAll ? 'auto' : '15rem')};
