...
export const CommitteePermissionsTableContainer = styled.div`
	width: 95rem;
	margin-top: 8rem;
`;

export const CommitteePermissionsHeader = styled.div`
	display: flex;
	align-items: center;
	flex: 1;
`;

export const CommitteePermissionsTitle = styled.p`
	font-size: 1.6rem;
	font-weight: 700;
